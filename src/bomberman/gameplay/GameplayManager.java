    ...
    public GameplayManager() {
        ...
        this.addMap(
            GameMap.builder()
                ...
                .horizontalPattern("WBWBWBWBWBWBWBW", TileAbility.NORMAL, 4)
                .horizontalPattern("WBWBWBWBWBWBWBW", TileAbility.NORMAL, 6)
                .horizontalPattern("WBWBWBWBWBWBWBW", TileAbility.NORMAL, 8)
                .horizontalPattern("WGWBWBWBWBWGWGW", TileAbility.NORMAL, 10)
        ...
        this.addMap(
            GameMap.builder()
                ...
                .frame(TileTypes.WALL)
                .fillEmpty(TileTypes.GROUND, TileAbility.NORMAL)
                .horizontalPattern("WGGGGGBBBGGGGGW", TileAbility.NORMAL, 1)
                .horizontalPattern("WGGGGGBBBGGGGGW", TileAbility.NORMAL, 2)
                .horizontalPattern("WGGBBBBBBBBBGGW", TileAbility.NORMAL, 3)
                .horizontalPattern("WGGBBBBBBBBBGGW", TileAbility.NORMAL, 4)
                .horizontalPattern("WBBBBPPPPPBBBBW", TileAbility.NORMAL, 5)
                .horizontalPattern("WBBBBPPPPPBBBBW", TileAbility.NORMAL, 6)
                .horizontalPattern("WBBBBPPPPPBBBBW", TileAbility.NORMAL, 7)
                .horizontalPattern("WGGBBBBBBBBBGGW", TileAbility.NORMAL, 8)
                .horizontalPattern("WGGBBBBBBBBBGGW", TileAbility.NORMAL, 9)
                .horizontalPattern("WGGGGGBBBGGGGGW", TileAbility.NORMAL, 10)
                .horizontalPattern("WGGGGGBBBGGGGGW", TileAbility.NORMAL, 11)
                .startPosition(1, 1)
                .startPosition(1, 11)
                .startPosition(12, 11)
                .startPosition(1, 11)
